package co.kr.api.restapisample.enumerated;
...
public enum ApiError {
    ...
    BAD_REQUEST_NO_ORDER(HttpStatus.BAD_REQUEST, "주문정보가 없습니다.", "주문번호를 확인해주세요."),
    ...
    BAD_REQUEST_OUT_STOCK(HttpStatus.BAD_REQUEST, "상품의 재고가 없습니다.", "상품의 재고가 없습니다."),
